...
from models.common_lora import *
...
class Detect(nn.Module):
    def __init__(self, nc=80, anchors=(), ch=()):  # detection layer
        ...
        LORA_RANK = int((self.no * self.na) // 10)
        LORA_ALPHA = int(LORA_RANK * 2)
        self.m = nn.ModuleList(lora.Conv2d(x, self.no * self.na, 1, r=LORA_RANK, lora_alpha=LORA_ALPHA) for x in ch)  # output conv
